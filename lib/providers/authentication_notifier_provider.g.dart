...
part of 'authentication_notifier_provider.dart';
...
String _$authenticationNotifierHash() =>
    r'124c09aba3c62e4a3d3a5254312fbb15842164f2';

/// See also [AuthenticationNotifier].
@ProviderFor(AuthenticationNotifier)
final authenticationNotifierProvider =
    AutoDisposeStreamNotifierProvider<AuthenticationNotifier, User?>.internal(
...
typedef _$AuthenticationNotifier = AutoDisposeStreamNotifier<User?>;
